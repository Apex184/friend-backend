...
function generateEmailTemplate({ senderName, senderTitle, senderDepartment, companyName, senderEmail, message, subject, date, disclaimer, address, fax, contactEmail, copyright }) {
    return `
